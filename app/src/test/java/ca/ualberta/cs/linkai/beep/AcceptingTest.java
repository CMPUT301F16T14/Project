...
public class AcceptingTest {
    // rider1
    Account testProfile1 = new Account("testRiderName1", "7807101111", "CMPUT301@ualberta.ca");

    // rider2
    Account testProfile2 = new Account("testRiderName2", "7807102222", "CMPUT302@ualberta.ca");

    // driver
    Account testProfile3 = new Account("testDriverName", "7807103333", "CMPUT303@ualberta.ca");
